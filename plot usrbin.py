...
counts, bins, bars = ax.hist(plotmodeaveenergy, bins=range(0, int(max(plotmodeaveenergy) + binwidth), binwidth), color='b',weights=weights)
...
fig, ax=plt.subplots()   
binwidth=1
plt.hist(listofclustersize, bins=range(0, int(max(listofclustersize) + binwidth)), width=1,color='b',weights=weights)
counts, bins, bars = plt.hist(listofclustersize, bins=range(0, int(max(listofclustersize) + binwidth)), width=1,color='b',weights=weights)
plt.xlabel("Size of Cluster - pixels")
plt.ylabel('%N')
xlim=40
ax.set_xlim([0,xlim])   
